...
const ARMOR_ITEMS: Item[] = [
    {
        ...
        cost: { gold: 500 },
        stats: { defense: 2, bonusXp: { Sleep: 1, Hygiene: 1, Flexibility: 1, Strength: 1, Cardio: 1, Social: 1 } },
        rarity: 'common',
    },
    {
        id: 'leather_armor',
        ...
        stats: { defense: 5, bonusXp: { Sleep: 2, Hygiene: 2, Flexibility: 2, Strength: 2, Cardio: 2, Social: 2 } },
        rarity: 'common',
    },
    {
        id: 'studded_leather',
    ...
    },
    {
        ...
        stats: { defense: 12, bonusXp: { Sleep: 3, Hygiene: 3, Flexibility: 3, Strength: 3, Cardio: 3, Social: 3 } },
        rarity: 'uncommon',
    },
    {
        id: 'iron_platebody',
        ...
        stats: { defense: 18, bonusXp: { Sleep: 5, Hygiene: 5, Flexibility: 5, Strength: 5, Cardio: 5, Social: 5 } },
        rarity: 'rare',
    },
    {
        id: 'steel_plate',
    ...
    },
    {
        ...
        cost: { gold: 100000, tickets: 120, diamonds: 75 },
        stats: { defense: 35, bonusXp: { Sleep: 7, Hygiene: 7, Flexibility: 7, Strength: 7, Cardio: 7, Social: 7 } },
        rarity: 'legendary',
    },
    {
        id: 'bronze_platebody',
    ...
    },
    {
        ...
        stats: { defense: 22, bonusXp: { Flexibility: 3, Cardio: 3 } },
        rarity: 'rare',
    },
    {
        id: 'dragonhide_vest',
    ...
    },
    {
        ...
        stats: { defense: 20, bonusXp: { Intelligence: 10 } },
        rarity: 'epic',
    },
];
...
const PET_ITEMS: Item[] = [
    ...
    },
    {
        ...
        cost: { tickets: 250, gold: 75000, diamonds: 50 },
    ...
    },
    {
        ...
        cost: { tickets: 500, gold: 150000, diamonds: 150 },
...
const FURNITURE_ITEMS: Item[] = [
    ...
    // Level 1-5: Basic items
    {
        ...
        type: 'furniture',
        category: 'general',
        unlockRequirement: { skills: [{ skill: 'Housemaid', level: 3 }] },
        cost: { gold: 1000 },
        stats: { bonusXp: { Housemaid: 1 } },
        rarity: 'common',
    },
    {
        id: 'wooden_chair',
        ...
        type: 'furniture',
        category: 'general',
        unlockRequirement: { skills: [{ skill: 'Housemaid', level: 5 }] },
        cost: { gold: 1500, tokens: { Housemaid: 5 } },
        stats: { bonusXp: { Housemaid: 1 } },
        rarity: 'common',
    },
    // Level 6-10: Better items
    {
        ...
        type: 'furniture',
        category: 'general',
        unlockRequirement: { skills: [{ skill: 'Housemaid', level: 7 }] },
        cost: { gold: 3000, tokens: { Housemaid: 10 } },
        stats: { bonusXp: { Housemaid: 2 } },
        rarity: 'uncommon',
    },
    {
        id: 'writing_desk',
        ...
        type: 'furniture',
        category: 'general',
        unlockRequirement: { skills: [{ skill: 'Housemaid', level: 10 }] },
        cost: { gold: 5000, tokens: { Housemaid: 15 } },
        stats: { bonusXp: { Housemaid: 2, Intelligence: 1 } },
        rarity: 'uncommon',
    },
    // Level 11-15: Fancy items
    {
        ...
        type: 'furniture',
        category: 'general',
        unlockRequirement: { skills: [{ skill: 'Housemaid', level: 12 }] },
        cost: { gold: 12000, diamonds: 10, tokens: { Housemaid: 20 } },
        stats: { bonusXp: { Housemaid: 3 } },
        rarity: 'rare',
    },
    {
        id: 'ornate_bed',
        ...
        type: 'furniture',
        category: 'sleep',
        unlockRequirement: { skills: [{ skill: 'Housemaid', level: 15 }] },
        cost: { gold: 20000, diamonds: 25, tokens: { Housemaid: 25 } },
        stats: { bonusXp: { Housemaid: 3, Sleep: 2 } },
        rarity: 'rare',
    },
    // Level 16-20: Premium items
    {
        ...
        type: 'furniture',
        category: 'general',
        unlockRequirement: { skills: [{ skill: 'Housemaid', level: 18 }] },
        cost: { gold: 35000, diamonds: 40, tokens: { Housemaid: 30 } },
        stats: { bonusXp: { Housemaid: 4 } },
        rarity: 'epic',
    },
    {
        id: 'enchanted_mirror',
        ...
        type: 'furniture',
        category: 'general',
        unlockRequirement: { skills: [{ skill: 'Housemaid', level: 20 }] },
        cost: { gold: 45000, diamonds: 50, tokens: { Housemaid: 35 } },
        stats: { bonusXp: { Housemaid: 4, Hygiene: 2 } },
        rarity: 'epic',
    },
    // Level 21-25: Royal items
    {
        ...
        type: 'furniture',
        category: 'sleep',
        unlockRequirement: { skills: [{ skill: 'Housemaid', level: 23 }] },
        cost: { gold: 60000, diamonds: 75, tokens: { Housemaid: 40 } },
        stats: { bonusXp: { Housemaid: 5, Sleep: 3 } },
        rarity: 'epic',
    },
    {
        id: 'arcane_bookshelf',
        ...
        type: 'furniture',
        category: 'general',
        unlockRequirement: { skills: [{ skill: 'Housemaid', level: 25 }] },
        cost: { gold: 80000, diamonds: 100, tokens: { Housemaid: 50 } },
        stats: { bonusXp: { Housemaid: 5, Intelligence: 3 } },
        rarity: 'legendary',
    },
    // Level 30+: Legendary with Cleanliness Aura
    {
        ...
        type: 'furniture',
        category: 'general',
        unlockRequirement: { skills: [{ skill: 'Housemaid', level: 30 }] },
        cost: { gold: 150000, diamonds: 250, tokens: { Housemaid: 75 } },
        stats: { bonusXp: { Housemaid: 10, Sleep: 5, Hygiene: 5 } },
        rarity: 'legendary',
    },
    // ========== PRESTIGE COMBAT FURNITURE ==========
    {
        ...
        type: 'furniture',
        category: 'general',
        unlockRequirement: { skills: [{ skill: 'Housemaid', level: 40 }] },
        cost: { gold: 45000, diamonds: 50, tokens: { Housemaid: 40 } },
        stats: { bonusXp: { Housemaid: 5 } },
        rarity: 'epic',
    },
    {
        ...
        type: 'furniture',
        category: 'general',
        unlockRequirement: { skills: [{ skill: 'Housemaid', level: 60 }] },
        cost: { gold: 100000, diamonds: 125, tokens: { Housemaid: 60 } },
        stats: { attack: 10, bonusXp: { Housemaid: 7, Strength: 3 } },
        rarity: 'epic',
    },
    {
        id: 'gilded_bathtub',
        ...
        type: 'furniture',
        category: 'hygiene',
        unlockRequirement: { skills: [{ skill: 'Housemaid', level: 80 }] },
        cost: { gold: 250000, diamonds: 375, tokens: { Housemaid: 90 } },
        stats: { bonusXp: { Housemaid: 10, Hygiene: 5, Sleep: 3 } },
        rarity: 'legendary',
    },
    {
        id: 'archmage_desk',
        ...
        type: 'furniture',
        category: 'general',
        unlockRequirement: { skills: [{ skill: 'Housemaid', level: 100 }] },
        cost: { gold: 1000000, diamonds: 1000, tokens: { Housemaid: 150 } },
        stats: { bonusXp: { Housemaid: 15, Intelligence: 10 } },
        rarity: 'legendary',
    },
];
...
const CONSUMABLE_ITEMS: Item[] = [
    ...
    },
    {
        ...
        description: 'Get an extra board roll',
        icon: '🎲',
        type: 'consumable',
        category: 'general',
        unlockRequirement: {},
