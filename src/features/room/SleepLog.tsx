                ...
                <div className="sleep-log-content">
                    {history.length === 0 ? (
                        ...
                        <div className="history-list">
                            {history.map((entry: { date: string; sleepScore: number; readinessScore: number; xpEarned: number; skipped?: boolean }, index: number) => (
                                <div key={`${entry.date}-${index}`} className="history-entry">
                                    ...
                                    <div className="entry-stats">
                                        {entry.skipped ? (
                                            <div className="entry-stat skipped" style={{ width: '100%', fontStyle: 'italic', color: '#94a3b8' }}>
                                                Not Tracked
                                            </div>
                                        ) : (
                                            <>
