...
export const ENEMY_DB: Record<string, EnemyDef> = {
    ...
    'chaos_of_clutter': {
        ...
        requiredAtk: 8,
        requiredDef: 5,
        requiredSkill: { skill: 'Housemaid', level: 5 },
        abilities: [
            {
                id: 'scatter_strike',
                name: 'Scatter Strike',
    ...
    'shadow_titan': {
        ...
        critRate: 0.12,
        critDmg: 2.0,
        goldReward: 200,  // 3x normal legendary rewards
    ...
    'golden_slime': {
        ...
        critRate: 0,
        critDmg: 1.0,
        goldReward: 500,  // Massive gold drop
        xpReward: 50,
        requiredAtk: 0,
        requiredDef: 0,
        abilities: [
